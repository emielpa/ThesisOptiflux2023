...
savings36 = np.array([0,1387.42, 2120.62,2931.78])
...
optiFluxSubs = [200,300,400,500,600,700]
...
plt.plot(optiFluxSubs,pbOneDrive2740, label = "1 fan/1 drive 0,27 €/kWh", color = "blue", linestyle = "dotted")
plt.plot(optiFluxSubs,pbOneDrive3640, label = "1 fan/1 drive 0,36 €/kWh", color = "blue", linestyle = "solid")
plt.plot(optiFluxSubs,pbOneDrive4540, label = "1 fan/1 drive 0,45 €/kWh", color = "blue", linestyle = "dashed")

plt.plot(optiFluxSubs,pbMultipleFan2740, label = "2 fans/1 drive 0,27 €/kWh", color = "orange", linestyle = "dotted")
plt.plot(optiFluxSubs,pbMultipleFan3640, label = "2 fans/1 drive 0,36 €/kWh", color = "orange", linestyle = "solid")
plt.plot(optiFluxSubs,pbMultipleFan4540, label = "2 fans/1 drive 0,45 €/kWh", color = "orange", linestyle = "dashed")

plt.plot(optiFluxSubs,pbInstalled2740, label = "Drive installed 0,27 €/kWh", color = "red", linestyle = "dotted")
plt.plot(optiFluxSubs,pbInstalled3640, label = "Drive installed 0,36 €/kWh", color = "red", linestyle = "solid")
...
plt.xlabel("Yearly subscription per cold store [€]")
plt.ylabel("Payback period [years]")
plt.plot(optiFluxSubs,pbOneDrive2730, label = "One drive 0,27 €/kWh", color = "blue", linestyle = "dotted")
plt.plot(optiFluxSubs,pbOneDrive3630, label = "One drive 0,36 €/kWh", color = "blue", linestyle = "solid")
plt.plot(optiFluxSubs,pbOneDrive4530, label = "One drive 0,45 €/kWh", color = "blue", linestyle = "dashed")

plt.plot(optiFluxSubs,pbMultipleFan2730, label = "Multiple fans per drive 0,27 €/kWh", color = "orange", linestyle = "dotted")
plt.plot(optiFluxSubs,pbMultipleFan3630, label = "Multiple fans 0,36 €/kWh", color = "orange", linestyle = "solid")
plt.plot(optiFluxSubs,pbMultipleFan4530, label = "Multiple fans 0,45 €/kWh", color = "orange", linestyle = "dashed")

plt.plot(optiFluxSubs,pbInstalled2730, label = "Drive Installed 0,27 €/kWh", color = "red", linestyle = "dotted")
plt.plot(optiFluxSubs,pbInstalled3630, label = "Drive Installed 0,36 €/kWh", color = "red", linestyle = "solid")
...
plt.xlabel("Yearly subscription per cold store [€]")
plt.ylabel("Payback period [years]")
plt.plot(optiFluxSubs,pbOneDrive2720, label = "One drive 0,27 €/kWh", color = "blue", linestyle = "dotted")
plt.plot(optiFluxSubs,pbOneDrive3620, label = "One drive 0,36 €/kWh", color = "blue", linestyle = "solid")
plt.plot(optiFluxSubs,pbOneDrive4520, label = "One drive 0,45 €/kWh", color = "blue", linestyle = "dashed")

plt.plot(optiFluxSubs,pbMultipleFan2720, label = "Multiple fans per drive 0,27 €/kWh", color = "orange", linestyle = "dotted")
plt.plot(optiFluxSubs,pbMultipleFan3620, label = "Multiple fans 0,36 €/kWh", color = "orange", linestyle = "solid")
plt.plot(optiFluxSubs,pbMultipleFan4520, label = "Multiple fans 0,45 €/kWh", color = "orange", linestyle = "dashed")

plt.plot(optiFluxSubs,pbInstalled2720, label = "Drive Installed 0,27 €/kWh", color = "red", linestyle = "dotted")
plt.plot(optiFluxSubs,pbInstalled3620, label = "Drive Installed 0,36 €/kWh", color = "red", linestyle = "solid")
